...
public class GUIComponents {
    ...
    public static JPanel buttonsPanel, displayPanel,showAlgorithmPanel;//
    ...
    private static void initButtonsPanel() {
        ...
        buttonsPanel.setPreferredSize(new Dimension(Configs.BUTTONS_PANEL_WIDTH, Configs.BUTTONS_PANEL_HEIGHT));//kich thuoc panel
    ...
    public static void initTextArea() {
    	    	...
    	    	textArea.setBounds(1,2,Configs.BUTTONS_PANEL_WIDTH, Configs.BUTTONS_PANEL_HEIGHT);
    }
}
